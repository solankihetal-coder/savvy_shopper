...
<head>
  <meta charset="UTF-8">
  <link rel="shortcut icon" type="logo-icon" href="">
...
<!-- navbar -->
  <nav class="navbar">
    <div class="logo"><img src="logo.png" alt="logo" width="190px"></div>
    <ul class="menu">
     ...
     <li><a href="register.html">Join Membership/Contact</a></li>
      <li><a href="logout.php" class="button1">Logout</a> </li>
      <!-- <li><a href="#search"><img src="search.png" alt="" width="20px"></a></li>
      <li><a href="#cart"><img src="cart.png" alt="" width="25px"></a></li> -->
    </ul>
  </nav>
  ...
  <div id="header">
    <div class="container">
      <div class="background-container">
        ...
        <div class="row">
          <div class="header-col1"><img src="herbal.png" alt="" style="width:80%"> <br><br>
            ...
            <div class="header-col2">
              <h1>Pure <span>Herbal</span> Products</h1>
                ...
                <br><br>
                <a href=""><img src="facebook.png" alt="" width="33px"></a>
                <a href=""><img src="whatsapp.png" alt="" width="33px"></a>
                <a href=""><img src="tweet.png" alt="" width="33px"></a>
                <a href=""><img src="instagram.png" alt="" width="46px"></a>
            </div>
        </div>
    </div>
</div>
...
<div id="categories">
    ...
    <div class="row">
      <div class="columnc1">
        <div class="card">
          <img src="tea.png" alt="Avatar" style="width:50%"></a><hr>
      ...
      <div class="columnc2">
        <div class="card" >
          <img src="nutrition.png" alt="Avatar" style="width:50%"></a><hr>
          <h4>Skin Care</h4>
      ...
      <div class="columnc3">
        <div class="card">
          <img src="beauty.png" alt="Avatar" style="width:50%"></a><hr>
      ...
      <div class="columnc4">
        <div class="card">
          <img src="health.png" alt="Avatar" style="width:50%"></a><hr>
          <h4>Home Care</h4>
    ...
    <div class="row">
        <div class="columnc1">
          <div class="card">
            <img src="lifestyle.png" alt="Avatar" style="width:50%"><hr>
            <h4>Personal Care</h4>
        ...
        <div class="columnc2">
          <div class="card">
            <img src="babycare.png" alt="Avatar" style="width:50%"><hr>
            <h4>Baby Care</h4>
        ...
        <div class="columnc3">
          <div class="card">
            <img src="books.png" alt="Avatar" style="width:50%"><hr>
        ...
        <div class="columnc4">
          <div class="card">
            <img src="wellness.png" alt="Avatar" style="width:50%"><hr>
            <h4>Food Products</h4>
  ...
  <div class="container">
    ...
    <p align="center">"Every Herb Has a Story—Find Yours Here."</p>
      <div class="row">
          ...
          <div class="about-col2"><img src="remedies2.png" alt="" style="width:80%">
          </div>
...
<!-- Product information pannel -->
 <div id="shopping"><hr style="margin-left:11%;margin-right:11%;">
    ...
    <div class="container">
    <div class="row1">
    <figure class="snip1107"><img src="blueberry-2350367_1920.jpg" alt="sampl31"/>
      <figcaption>
    ...
    <figure class="snip1107"><img src="turmeric.jpg" alt="sample48"/>
      <figcaption>
        <div><span>Buy Now</span></div>
        <div>
          <h4>Shri Haldi</h4>
    ...
    <figure class="snip1107"><img src="massageoil.jpg" alt="sample12"/>
      <figcaption>
        <div><span>Buy Now</span></div>
        <div>
          <h4>Massage Oil</h4>
  ...
  <div class="row1">
    <figure class="snip1107"><img src="tulsi-1539181_1920.jpg" alt="sampl31"/>
      <figcaption>
        <div><span>Buy Now</span></div>
        <div>
          <h4>Shri Tulsi</h4>
    ...
    <figure class="snip1107"><img src="capsules-1079838_1920.jpg" alt="sample48"/>
      <figcaption>
        <div><span>Buy Now</span></div>
        <div>
          <h4>Aloe Digest</h4>
    ...
    <figure class="snip1107"><img src="agarbatti.jpg" alt="sample12"/>
      <figcaption>
        <div><span>Buy Now</span></div>
        <div>
...
<div id="contact">
  ...
  <div class="row">
      <div class="contact-left">
        <img src="contact1.png" alt="" width="70%">
      </div>
...
<br><br>
  ...
  <footer>
    ...
    <div class="row">
      <div class="columnfo1">
    <div class="logo">
      <img src="logo.png" alt="logo" style="width: 210px;">
  ...
  <div class="columnfo1">
        <ul>
          ...
          <li><img src="email.jpg" alt="" style="width: 15px;">&nbsp;SavvyShopper11@gmail.com</li>
          <li><img src="call-removebg-preview.png" alt="" style="width: 15px;">&nbsp;0123456789</li>
          <li><img src="instagram-removebg-preview.png" alt="" style="width: 20px;">SavvyShopper_11</li>
        </ul>
    </div>
    <div class="columnfo1">
      <h4><a href="register.html" style="color:black;text-decoration: none;">Get membership Now</a></h4>
    </div>
  </div>
</div>
  </div>
